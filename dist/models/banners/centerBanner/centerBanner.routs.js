...
router.post("/create", isAuth_1.isAuth, isAdmin_1.isAdmin, multer_1.upload.array("images", 4), centerBanner_controllers_1.createCenterBanner);
...
router.put("/:id", isAuth_1.isAuth, isAdmin_1.isAdmin, multer_1.upload.array("images", 4), centerBanner_controllers_1.updateCenterBanner);
