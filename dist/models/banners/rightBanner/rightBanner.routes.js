...
router.post("/create", isAuth_1.isAuth, isAdmin_1.isAdmin, multer_1.upload.array("images", 4), rightBanner_controllers_1.createRightBanner);
router.get("/get", rightBanner_controllers_1.getAllRightBanners);
router.get("/:id", rightBanner_controllers_1.getSingleRightBanner);
router.put("/:id", isAuth_1.isAuth, isAdmin_1.isAdmin, multer_1.upload.array("images", 4), rightBanner_controllers_1.updateRightBanner);
