...
router.post("/create", isAuth_1.isAuth, isAdmin_1.isAdmin, multer_1.upload.array("images", 4), leftBanner_controllers_1.createLeftBanner);
router.get("/get", leftBanner_controllers_1.getAllLeftBanners);
router.get("/:id", leftBanner_controllers_1.getSingleLeftBanner);
router.put("/:id", isAuth_1.isAuth, isAdmin_1.isAdmin, multer_1.upload.array("images", 4), leftBanner_controllers_1.updateLeftBanner);
