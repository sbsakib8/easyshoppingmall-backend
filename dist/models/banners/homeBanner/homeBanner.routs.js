...
router.post("/create", isAuth_1.isAuth, isAdmin_1.isAdmin, multer_1.upload.array("images"), homeBanner_controllers_1.createHomeBanner);
router.get("/get", homeBanner_controllers_1.getAllHomeBanners);
router.get("/:id", homeBanner_controllers_1.getSingleHomeBanner);
router.put("/:id", isAuth_1.isAuth, isAdmin_1.isAdmin, multer_1.upload.array("images"), homeBanner_controllers_1.updateHomeBanner);
