...
import { createCenterBanner, deleteCenterBanner, getAllCenterBanner, getSingleCenterBanner, updateCenterBanner, toggleCenterBannerStatus } from "./centerBanner.controllers";
...
router.patch("/:id/toggle-active", isAuth, isDashboardAccess("banner"), toggleCenterBannerStatus);
