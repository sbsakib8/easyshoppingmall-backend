...
import { deleteUser, exportUsers, getAllUsers, getCustomers, getUserById, getUserProfile, googleAuth, resetpassword, sendotp, signIn, signOut, signUp, updateUserProfile, userImage, verifyotp } from "./user.controllers";
...
router.get("/customers", isAuth, isDashboardAccess("customers"), getCustomers);
